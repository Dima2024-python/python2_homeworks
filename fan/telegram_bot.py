...
def start_bot(message):
    if message.text == "/start":
        bot.send_message(
            message.chat.id,
            text=f"Hello {message.from_user.first_name}, it's bot of game " f"''Brawl Stars''",
...
def get_rarest(message):
    ...
    bot.send_message(message.chat.id, text="Its all brawlers in this rarest", reply_markup=rarest_keyboard)
